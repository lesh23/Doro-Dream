...
tr_18 = pd.read_csv('전처리_18년전국관광객수.csv')
tr_19 = pd.read_csv('전처리_19년전국관광객수.csv')
tr_20 = pd.read_csv('전처리_20년전국관광객수.csv')
tr_21 = pd.read_csv('전처리_21년전국관광객수.csv')

# 시도별 18,19,20,21년도 관광지출액 변수 선언
mo_18 = pd.read_csv('전처리_18년전국관광지출액.csv')
mo_19 = pd.read_csv('전처리_19년전국관광지출액.csv')
mo_20 = pd.read_csv('전처리_20년전국관광지출액.csv')
mo_21 = pd.read_csv('전처리_21년전국관광지출액.csv')
...
# 관광소비지수 csv파일 저장
exp_score.to_csv('1차지역선정_관광소비지수.csv', index=False, encoding = 'utf-8')
