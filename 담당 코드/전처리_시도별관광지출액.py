...
mo18_lo = pd.read_excel('money18_lo.xlsx',header=0)
...
mo18_fo = pd.read_excel('money18_fo.xlsx',header=0)
...
mo19_lo = pd.read_excel('money19_lo.xlsx',header=0)
...
mo19_fo = pd.read_excel('money19_fo.xlsx',header=0)
...
mo20_lo = pd.read_excel('money20_lo.xlsx',header=0)
...
mo20_fo = pd.read_excel('money20_fo.xlsx',header=0)
...
mo21_lo = pd.read_excel('money21_lo.xlsx',header=0)
...
mo21_fo = pd.read_excel('money21_fo.xlsx',header=0)
...
mo18.to_csv('전처리_18년전국관광지출액.csv', index=False, encoding = 'utf-8')
mo19.to_csv('전처리_19년전국관광지출액.csv', index=False, encoding = 'utf-8')
mo20.to_csv('전처리_20년전국관광지출액.csv', index=False, encoding = 'utf-8')
mo21.to_csv('전처리_21년전국관광지출액.csv', index=False, encoding = 'utf-8')
