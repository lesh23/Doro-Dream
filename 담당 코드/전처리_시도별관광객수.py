...
# 변수 선언
tr18 = pd.read_excel('tr18.xlsx',header=0)
tr19 = pd.read_excel('tr19.xlsx',header=0)
tr20 = pd.read_excel('tr20.xlsx',header=0)
tr21 = pd.read_excel('tr21.xlsx',header=0)
...
tr_18.to_csv('전처리_18년전국관광객수.csv', index=False, encoding = 'utf-8')
tr_19.to_csv('전처리_19년전국관광객수.csv', index=False, encoding = 'utf-8')
tr_20.to_csv('전처리_20년전국관광객수.csv', index=False, encoding = 'utf-8')
tr_21.to_csv('전처리_21년전국관광객수.csv', index=False, encoding = 'utf-8')
...
# 전처리 결과를 csv파일로 저장
tr_score.to_csv('전처리_시도별관광객수정규화.csv', index=False, encoding = 'utf-8')
